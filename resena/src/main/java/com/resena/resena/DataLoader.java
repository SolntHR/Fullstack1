...
public class DataLoader {
    ...
    CommandLineRunner initResenas(ResenaRepository repository) {
        return args -> {
            ...
            if (!repository.existsByIdItemCarrito(1)) {
                Resena r1 = new Resena();
                r1.setIdUsuario(1);
                r1.setIdProducto(1);
                r1.setIdItemCarrito(1);
                r1.setEstrellas(5);
            ...
            if (!repository.existsByIdItemCarrito(2)) {
                Resena r2 = new Resena();
                r2.setIdUsuario(1);
                r2.setIdProducto(2);
                r2.setIdItemCarrito(2);
                r2.setEstrellas(4);
            ...
            if (!repository.existsByIdItemCarrito(3)) {
                Resena r3 = new Resena();
                r3.setIdUsuario(2);
                r3.setIdProducto(3);
                r3.setIdItemCarrito(3);
                r3.setEstrellas(5);
            ...
            if (!repository.existsByIdItemCarrito(4)) {
                Resena r4 = new Resena();
                r4.setIdUsuario(2);
                r4.setIdProducto(4);
                r4.setIdItemCarrito(4);
                r4.setEstrellas(4);
